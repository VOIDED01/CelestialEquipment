...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    public ModItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, CelestialEquipment.MOD_ID, existingFileHelper);
    }

    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = CelestialEquipment.MOD_ID;
    ...
    protected void registerModels() {
        ...
        handHeldItem(ModItems.CELESTIUM_ROD);
    ...
    private ItemModelBuilder simpleItem(RegistryObject<Item> item) {
        return withExistingParent(item.getId().getPath(), new ResourceLocation("item/generated"))
                .texture("layer0", new ResourceLocation(CelestialEquipment.MOD_ID, "item/" + item.getId().getPath()));
    }
